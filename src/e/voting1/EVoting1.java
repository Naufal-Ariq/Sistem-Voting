...
public class EVoting1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("========================");
        for (int i = 1; i <= 3; i++) {
            System.out.println("Kandidat " + (char) ('A' + i - 1) + ": " + suaraKandidat[i] + " suara");
        }
        System.out.println("Tidak Memilih: " + totalSuaraTidakMemilih + " suara");
        System.out.println("Jumlah Partisipan yang Telah Voting: " + pemilihListCount(pemilihList));
    ...
    private static void displayQueue(CustomQueue queue) {
